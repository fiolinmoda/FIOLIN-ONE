...
public interface IProductVariantRepository
{
    ...
    Task<ProductColor> GetOrCreateColorAsync(string color, CancellationToken cancellationToken);
    Task<ProductSize> GetOrCreateSizeAsync(string size, CancellationToken cancellationToken);
