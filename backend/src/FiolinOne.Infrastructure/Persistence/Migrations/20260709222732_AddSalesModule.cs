        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    sales_order_number = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_sales_orders_customer_name",
                table: "sales_orders",
                column: "customer_name");

            migrationBuilder.CreateIndex(
                name: "IX_sales_orders_sales_order_number",
                table: "sales_orders",
